...
여기서 Loss 함수는 Contrastive Loss, Triplet Loss 두가지 방법으로 접근했습니다. 
결론적으로는 Contrastive가 정확도 80%정도 나왔고, Triplet이 92%로 정확도가 더 높았습니다

**Contrastive Loss**

ContrastiveLoss를 정의하고, Euclidean Distance를 위한 함수도 정의합니다.  
...
Triplet loss는 동일한 Embedding Network를 사용했고, 
Loss 함수와 Build 함수만 다르게 구현했습니다. 
...
Test는 embedding_network를 통해 좌표를 출력하고,
비교하고자하는 이미지의 거리를 np.linalg.norm 함수로 계산하면 됩니다. 
